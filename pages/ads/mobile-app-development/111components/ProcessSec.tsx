...
interface ProcessComponentProps {
  ...
  const ProcessComponent: React.FC<ProcessComponentProps> = ({ title, description, processSlides }) => {
    return (
      <div className="lg:py-16 py-10 max-w-[1600px] mx-auto lg:px-10 px-6">
        <h2 className="xl:text-4xl text-3xl text-[#212121] mt-3 font-bold text-center">{title}</h2>
        <p className="xl:text-base text-sm text-black text-center lg:w-2/3 mx-auto w-full">{description}</p>
        <div className={styles.processContent}>
          ...
          {processSlides && processSlides.length > 0 ? (
