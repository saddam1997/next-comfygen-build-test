      ...
      <div className=" lg:py-16 py-10">
        <div className="space-y-2">
          ...
          <p className="text-black lg:w-1/2 mx-auto text-center">
            At Comfygen, we specialize in developing digital, crypto, and next-generation wallets to cater to businesses, enterprises, and individual users. Our wallet development solutions combine security, usability, and advanced features to help you manage digital assets efficiently and safely.
          </p>
        </div>
