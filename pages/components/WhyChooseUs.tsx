...
//             <p className="text-base text-[#212121] font-normal mt-2 w-full" dangerouslySetInnerHTML={{ __html: description }}/>
//           </div>
//           <div>
//             <a href="https://api.whatsapp.com/send?phone=919587867258">
//               <button className="text-base w-[225px] font-medium text-white rounded-full px-8 py-3.5 text-center bg-[#5556D1] cursor-pointer transition duration-300 flex items-center">Connect to expert</button>
//             </a>
//           </div>
//         </div>
//         <div className="grid lg:grid-cols-4 grid-cols-2 lg:gap-6 mt-10">
//           <div className="lg:bg-center lg:flex hidden justify-end items-end  bg-no-repeat bg-cover bg-left  px-6 py-8 rounded-lg"
//             style={{ backgroundImage: `url(${mainCardData?.imageUrl})` }} >
//             <div>
//               <h2 className="xl:text-xl text-xl text-[#fff] font-semibold">{mainCardData.title}</h2>
//               <p className="text-base font-normal text-white" dangerouslySetInnerHTML={{ __html: mainCardData.description }}/>
//               <div className="mt-4">
//                 <a href="/contact-us">
//                 <button className="text-base border border-white font-medium text-white rounded-full px-8 py-2.5 text-center cursor-pointer transition duration-300 flex items-center hover:bg-white hover:text-black ">Get in Touch</button>
//                 </a>
//               </div>
//             </div>
//           </div>
...
//                     <p className="text-sm font-normal" dangerouslySetInnerHTML={{ __html: item.description }} />
//                   </div>
//                 </div>
//               ))}
//             </div>
