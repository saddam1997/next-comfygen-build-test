            ...
            <div className="space-y-5 mt-8">
              <a href="tel:9587867258" className="flex items-center gap-3 cursor-pointer" >
                ...
                <div>
                  ...
                  <p className="text-white text-lg font-semibold">+91 9587867258</p>
                </div>
              </a>
              <a href="mailto:sales@comfygen.com" className="flex items-center gap-3 cursor-pointer" >
                <Image
                ...
                <div>
                  ...
                  <p className="text-white text-lg font-semibold">sales@comfygen.com</p>
                </div>
              </a>
              <a href="https://www.comfygen.com" className="flex items-center gap-3 cursor-pointer" >
                <Image
                ...
                <div>
                  ...
                  <p className="text-white text-lg font-semibold">www.comfygen.com</p>
                </div>
              </a>
            </div>

            <div className="mt-6" >
              <h2 className="text-white font-semibold lg:text-xl md:text-lg text-base">Social Links</h2>
            ...
            <div className="space-y-5 col-span-2">
              <a href="tel:9587867258" className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-white lg:text-lg text-base font-semibold">+91 9587867258</p>
                </div>
              </a>
              <a target="_blank" href="https://maps.app.goo.gl/ZioMz8iAfPoLJGRz5" className="flex items-start gap-2">
                <Image
                ...
                />
                <div>
                  <span className="text-white lg:text-base text-sm">Office Location</span>
                  <p className="text-white lg:text-lg text-base font-semibold">A-20 Basement, Samridhi Enclave, Ajmer Rd, Modi Nagar, Jaipur, Rajasthan 302006</p>
                </div>
              </a>
            </div>
          </div>
          <div className="bg-[#FFFFFF]/20 py-6 px-6 h-full rounded-xl xl:gap-8 gap-4 grid lg:grid-cols-3 grid-cols-1 items-center">
            ...
            <div className="space-y-5 lg:col-span-2">
              <a href="tel:579-977-4475" className="flex items-start gap-2">
                ...
                <div>
                  <span className="text-white lg:text-base text-sm">Phone Number</span>
                  <p className="text-white lg:text-lg text-base font-semibold">+1 579-977-4475</p>
                </div>
              </a>
              <a target="_blank" href="https://maps.app.goo.gl/zazMknjBpVCo9xe57" className="flex items-start gap-2">
                <Image
                  src="https://www.comfygen.com/image/location-icon-icon.svg"
                  alt=""
                  height={37}
                ...
                <div>
                  <span className="text-white lg:text-base text-sm">Office Location</span>
                  <p className="text-white lg:text-lg text-base font-semibold">40 Tuxedo Ct, Toronto, ON M1G 3S7, Canada</p>
                </div>
              </a>
            </div>
          </div>
