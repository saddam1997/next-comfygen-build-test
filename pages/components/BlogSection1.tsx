...
export default function BlogSection(props: any) {
  ...
  return (
    <div className="bg-white">
      <section className="space-y-8 py-8 lg:py-16 mx-auto 2xl:w-9/12 xl:w-5/6 w-11/12">
        ...
        <div className="grid gap-10 py-5 mx-auto lg:grid-cols-3 md:grid-cols-2 xl:gap-6">
          {props?.initialData && props?.initialData?.length > 0
            ? props?.initialData.map((element: any) =>
                element ? (
                  <div
                    key={element.link || element.id} // ✅ key on the top-level element
