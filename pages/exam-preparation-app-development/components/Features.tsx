...
const featuresData: Feature[] = [
  {
    ...
    img: "https://www.comfygen.com/image/user-panel-astrology-app-development.webp",
    additionalDetails: [
  ...
  },
  {
    ...
    img: "https://www.comfygen.com/image/astrologer-panel-astrology-app-development.webp",
    additionalDetails: [
  ...
  },
  {
    ...
    title: "Admin Panel",
    icon: <i className="fas fa-mobile-alt text-4xl"></i>,
    img: "https://www.comfygen.com/image/admin-panel-astrology-app-development.webp",
    additionalDetails: [
