    ...
    <div className="lg:py-16 lg:mt-10 py-10 bg-[#F5F5F9]">
      <div className="space-y-2">
        ...
        <p className="text-center text-gray-600 max-w-6xl mx-auto lg:px-8 px-4">
         to offer a seamless experience for users, salon professionals, and business administrators. Our salon booking mobile app development solutions include smart panel integrations that simplify operations, improve engagement, and support end-to-end salon management — all in one powerful app.
        </p>
      </div>
