...
const Aboutsection = dynamic(
  () => import("./Newcomponet/home/component/Aboutsection"),
  { ssr: true }
);

const Services = dynamic(
  () => import("./Newcomponet/home/component/Services"),
  { ssr: true }
);

const Portfolios = dynamic(
  () => import("./Newcomponet/home/component/Portfolios"),
  { ssr: true }
);


const IndustriesWeServe = dynamic(
  () => import("./Newcomponet/home/component/IndustriesWeServe"),
  { ssr: true }
);

const Calltoaction = dynamic(
  () => import("./Newcomponet/home/component/Calltoaction"),
  { ssr: true }
);

const DevelopmentProcess = dynamic(
  () => import("./Newcomponet/home/component/DevelopmentProcess"),
  { ssr: true }
);

const TechStacks = dynamic(
  () => import("./Newcomponet/home/component/TechStacks"),
  { ssr: true }
);

const WhyChooseUs = dynamic(
  () => import("./Newcomponet/home/component/WhyChooseUs"),
  { ssr: true }
);

const ClientStories = dynamic(
  () => import("./Newcomponet/home/component/ClientStories"),
  { ssr: true }
);

const HireDeveloper = dynamic(
  () => import("./Newcomponet/home/component/HireDeveloper"),
  { ssr: true }
);

const ClientTestimonials = dynamic(
  () => import("./Newcomponet/home/component/ClientTestimonials"),
  { ssr: true }
);
