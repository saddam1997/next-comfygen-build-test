        ...
        <div className="grid lg:grid-cols-2 mx-auto items-center gap-14">
          <div>
            <div className="space-y-4">
              ...
              <div className="space-y-4">
                <p className="xl:text-base text-sm text-black" dangerouslySetInnerHTML={{ __html: description1 }} />
                <p className="xl:text-base text-sm text-black" dangerouslySetInnerHTML={{ __html: description2 }} />
                <p className="xl:text-base text-sm text-black" dangerouslySetInnerHTML={{ __html: description3 }} />
                <p className="xl:text-base text-sm text-black" dangerouslySetInnerHTML={{ __html: description4 }} />
                <p className="xl:text-base text-sm text-black" dangerouslySetInnerHTML={{ __html: description5 }} />
                ...
                <p className="xl:text-base text-sm text-black" dangerouslySetInnerHTML={{ __html: description6 }} />
              </div>
            </div>
            <div className="mt-7">
