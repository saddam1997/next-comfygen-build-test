        ...
        <footer className="bg-[#0C0F18]">
          ...
          <div className="space-y-8 md:px-4 py-10 lg:space-y-8 2xl:w-10/12 w-10/12 lg:w-11/12 mx-auto ">
            <div className="flex justify-center items-center rounded-2xl bg-no-repeat bg-cover p-10 bg-[url('https://www.comfygen.com/image/footer-top-img.webp')]" >
              <div className="">
                <h2 className="text-white lg:text-3xl text-2xl font-bold">Have a Project in Your Mind ?</h2>
                <p className="text-white font-normal mt-1 text-base lg:w-[60%] w-full">At Comfygen, we use creativity and teamwork to shape the direction of technology. Our innovative solutions help organisations stay ahead of the times in a world that is changing quickly. Together, let's develop
            ...
            <div className="grid grid-cols-1  gap-8  pt-8 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="space-y-6 ">
                ...
                <div className={`${styles.TechnologyStack} space-y-3 text-sm capitalize h-[500px] overflow-y-auto`}>
                  {JSON_DATA.BlockchainServ.map((elem) => {
              ...
              <div className="space-y-6">
                <p className="text-sm font-normal uppercase  text-[#ffffff]/70">Crypto & Token</p>
