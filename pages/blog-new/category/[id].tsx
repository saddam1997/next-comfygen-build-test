  ...
  return (
    ...
    <div className='overflow-hidden'>
      ...
      <div className="md:bg-cover  bg-no-repeat md:bg-left bg-center" style={{ backgroundImage: `url("https://www.comfygen.com/images/blog-cover.jpeg")` }}>
        <div className=" 2xl:h-[calc(100vh-30rem)] xl:h-[calc(100vh-20rem)]  lg:h-[calc(100vh-24rem)] md:h-80 h-60  bg-gradient-to-r from-[#386ED4]  to-[#6243BA]/0   md:flex items-center">
          <div className="2xl:w-4/6 xl:w-5/6 w-11/12  mx-auto flex md:flex-row flex-col-reverse  md:items-center md:justify-start justify-center py-10">
            {/* text-section */}
            <div data-aos="fade-right" data-aos-delay="50" data-aos-duration="1000" className="space-y-6 lg:w-3/6 lg:text-left text-center ">
        ...
        <div className='flex xl:justify-center justify-start space-x-6 w-full overflow-x-auto px-4 py-10'>
          {
            category && category && category && category.length > 0 ?
              category.map((element: any, index: any
                ...
                <button onClick={() => { router.push(element.shortName); () => window.scroll(50, 500); setactive(index); }} className={active === index ? 'bg-blue-500 text-white px-4 capitalize py-1 rounded-full whitespace-nowrap' : 'bg-transparent border  text-slate-600 px-4 capitalize py-1 rounded-full whitespace-nowrap '}> {element && element.shortName ? element.shortName : null}</button>
              ))
      ...
      <div data-aos="fade-up" data-aos-delay="50" id='blog'
                ...
                finalData && finalData && finalData.length > 0 ?
                  finalData.map((element: any, index: any
                    ...
                    <div key={index}
                      ...
                      <div className='w-full xl:h-60 lg:h-64 h-60 relative object-cover' >
