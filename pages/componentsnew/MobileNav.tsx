          ...
          >
            ...
            <div className="font-medium text-[#212121] divide-y divide-white/10">
              ...
              <div>
                ...
                <div
                  className={`bg-transparent  text-[#212121] font-normal pl-4 text-sm capitalize  overflow-hidden transition-[max-height] duration-300 ease-in ${
              ...
              >
                <div className="flex items-center space-x-2 ">
                  <TiShoppingCart className="text-[#212121]" size={22} />
