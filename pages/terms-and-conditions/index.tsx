  ...
  return (
    <>
      <div className="overflow-hidden">
        <Head>
          <title> Terms and Conditions - comfygen.com </title>
          <link rel="canonical" href="https://www.comfygen.com/terms-and-conditions" />
          <meta
            name="description"
            content=" Read our ComfyGen terms and conditions carefully before using our website. Learn about our policies on privacy, intellectual property, and user-generated content. By accessing and using our website."
          />
          ...
          <meta property="og:url" content="https://www.comfygen.com/terms-and-conditions" />
          ...
          <section className="2xl:w-4/6 xl:w-5/6 w-11/12  mx-auto">
            <div className="flex lg:space-x-10 ">
              ...
              <div className="bg-white text-left   space-y-4  p-4 flex-1">
                <h2 className="md:text-5xl text-3xl text-[#0E1F51] font-semibold">Terms and Conditions</h2>
                <p className="">Last updated: April 26, 2022 Please read these terms and conditions carefully before using Our Service.</p>
                <h3 className="text-4xl text-blue-500 font-semibold">Interpretation and Definitions</h3>
                <h3 className="text-2xl text-[#0E1F51] font-semibold">Interpretation</h3>
                <p className="text-base text-black">The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.</p>
                <h3 className="text-2xl text-[#0E1F51] font-semibold">Definitions</h3>
                <p>For the purposes of these Terms and Conditions:</p>
                <p>
                  Affiliate means an entity that controls, is controlled by or is under common control with a party, where "control" means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.
                </p>

                <p>Country refers to: Rajasthan, India</p>

                <p>Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Comfygen Private Limited, 70, A Narayanpuri Jhotwara, Jaipur, Rajasthan, INDIA, 302012.
                </p>
                ...
                <h3 className="text-2xl text-[#0E1F51] font-semibold">Acknowledgment</h3>
                ...
                <h3 className="text-2xl text-[#0E1F51] font-semibold">Links to Other Websites</h3>
                ...
                <h3 className="text-2xl text-[#0E1F51] font-semibold">Termination</h3>
                <p>We may terminate or suspend Your access immediately, without prior notice or liability, for any reason whatsoever, including without limitation if You breach these Terms and Conditions.</p>

                <p>Upon termination, Your right to use the Service will cease immediately.
                </p>

                <h3 className="text-2xl text-[#0E1F51] font-semibold">Limitation of Liability</h3>
                ...
                <h3 className="text-2xl text-[#0E1F51] font-semibold">"AS IS" and "AS AVAILABLE" Disclaimer</h3>
                ...
                md:text-5xl text-3xl
                <p>
                  Some jurisdictions do not allow      {/* {showdata === 1 ? */}the exclusion of certain types of warranties or limitations on applicable statutory rights of a consumer, so some or all of the above exclusions and limitations may not apply to You. But in such a case the exclusions and limitations set forth in this section shall be applied to the greatest extent enforceable under applicable law.
                </p>

                <h3>Governing Law</h3>
                <p>The laws of the Country, excluding its conflicts of law rules, shall govern this Terms and Your use of the Service. Your use of the Application may also be subject to other local, state, national, or international laws.</p>

                <h3 className="text-2xl text-[#0E1F51] font-semibold">Disputes Resolution</h3>
                ...
                <h3 className="text-2xl text-[#0E1F51] font-semibold">For European Union (EU) Users</h3>
                <p>
                  If You are a European Union consumer, you will benefit from any mandatory provisions of the law of the country in which you are resident in.
                </p>

                <h3 className="text-2xl text-[#0E1F51] font-semibold">United States Legal Compliance</h3>
                <p>
                  You represent and warrant that (i) You are not located in a country that is subject to the United States government embargo, or that has been designated by the United States government as a "terrorist supporting" country, and (ii) You are not listed on any United States government list of prohibited or restricted parties.
                </p>

                <h3 className="text-xl text-[#0E1F51] font-semibold">Severability and Waiver</h3>
                <h3 className="text-2xl text-[#0E1F51] font-semibold">Severability</h3>
                <p>If any provision of these Terms is held to be unenforceable or invalid, such provision will be changed and interpreted to accomplish the objectives of such provision to the greatest extent possible under applicable law and the remaining provisions will continue in full force and effect.</p>

                <h3 className="text-xl text-[#0E1F51] font-semibold">Waiver</h3>
                <p>Except as provided herein, the failure to exercise a right or to require performance of an obligation under these Terms shall not effect a party's ability to exercise such right or require such performance at any time thereafter nor shall the waiver of a breach constitute a waiver of any subsequent breach.</p>

                <h3 className="text-2xl text-[#0E1F51] font-semibold">Translation Interpretation</h3>
                <p>These Terms and Conditions may have been translated if We have made them available to You on our Service. You agree that the original English text shall prevail in the case of a dispute.</p>

                <h3 className="text-xl text-[#0E1F51] font-semibold">Changes to These Terms and Conditions</h3>
