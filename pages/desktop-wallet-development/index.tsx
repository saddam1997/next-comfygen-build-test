...
export default function Ecommerce(props) {
  ...
  const jsonLdData = [
    ...
    },
    {
      ...
      "name": "Crypto Desktop Wallet Development | Secure & Multi-Currency Wallets",
      "image": "About-section-image",
      "description": "Comfygen develops secure, scalable, and feature-rich Crypto Desktop Wallets with multi-currency support, DeFi & NFT integration, and enterprise-grade security solutions for startups and enterprises.",
      "aggregateRating": {
