...
import BreadCume from "./component/BreadCume";
// import $ from "jquery";
...
export default function DesktopNav(props: any) {
  ...
  //   let ticking = false;
  //   const handleScroll = () => {
  //     const newScrollState = window.scrollY > 1000;
  //     if (!ticking) {
  //       window.requestAnimationFrame(() => {
  //         setIsScrolled(prev => {
  //           if (prev !== newScrollState) {
  ...
  const headerClasses = isScrolled
    ? "fixed top-0 w-full bg-white z-50  mx-auto "
    : "fixed top-0 w-full  text-white z-50  mx-auto ";
      ...
      <nav className="flex items-center justify-between px-4  py-0  md:px-0 relative 2xl:w-10/12 w-10/12 lg:w-11/12 mx-auto ">
        ...
        <div className="xl:block hidden">
          <Link href="/contact-us" passHref={true}>
            <span className="text-base font-medium text-white bg-gradient-to-r from-[#C05FE2] via-[#DD3D98] to-[#2A39DD] rounded-md px-8 py-3.5 text-center hover:text-white   cursor-pointer transition duration-300 relative flex gap-3 items-center ">
              Get a Quote
              <Image
                src="https://www.comfygen.com/image/button-arrow.svg"
                alt="button-arrow"
