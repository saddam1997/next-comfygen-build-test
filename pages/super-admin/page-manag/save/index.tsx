...
const getPageData = async (query: GetPageDataType) => {
    try {
        const data = await axiosPrivate.get("/component/getPageComponent", { params: query });
...
const HeaderPropsForm: React.FC = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            setLoading(true);
            const data = await getPageData({ pageId, componentId });
