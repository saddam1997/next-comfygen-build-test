...
const Panelheader = [
  {
    num: "01",
    title: <h2 className='py-4 text-[#fff] xl:text-4xl text-3xl font-bold xl:leading-[3rem] capitalize'> <span className='text-blue-600'>Technology Stack </span> for Doctor Appointment Booking Apps </h2> ,
    decs: "Wanna build the doctor appointment and scheduling app? Well gather the technologies to use and build a robust application: "
  },
];
