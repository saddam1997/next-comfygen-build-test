...
const Panelheader = [
  {
    num: "01",
    title: "Technology Included Blockchain Development",
    decs: "Hire offshore Blockchain developers with expertise in the newest Blockchain technology to create custom apps that meet your company's needs:"
  },
];
    ...
    <section className=' bg-gray-200'>
      <div className=" space-y-2 mx-auto 2xl:w-9/12 xl:w-5/6 w-11/12  py-10">
        ...
        <div className="xl:flex  items-start xl:space-x-16 xl:space-y-0 space-y-8 w-full py-10">
          <div className="flex flex-col items-center space-y-6  justify-start bg-white p-4 w-full">
            <span
          ...
          <div className="grid md:grid-cols-3 grid-cols-1 divide-x-1 md:gap-6 gap-4 relative capitalize w-full bg-white p-4">
            {tech === 0 ? (
              <>
                {IosApp.map((elem: any) => {
