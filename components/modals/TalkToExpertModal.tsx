...
export default function TalkToExpertModal({
  ...
  return (
    ...
    >
      ...
      {/* Modal Container */}
      <div className="relative z-10 w-full max-w-[1500px] bg-white rounded-2xl shadow-2xl overflow-hidden">
        <div className="flex flex-col lg:flex-row lg:h-[600px]">
          ...
          <div className="relative hidden lg:flex w-[40%] overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col justify-end p-8 w-full bg-black/50 text-white">
