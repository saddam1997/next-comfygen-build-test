...
import ContactFromHeader from "../../old/components/ContactFromHeader";
    ...
    <div className="flex flex-col-reverse w-11/12 mx-auto 2xl:w-9/12 xl:w-5/6 lg:flex-row md:items-center lg:space-x-20 lg:space-y-0">
      <div className="w-full lg:pt-0 pt-10">
        <div className="space-y-6">
          ...
          <p className="w-full mx-auto text-2xl font-bold text-white/90 lg:text-base">
            {props.subhead}
          </p>
        ...
        <div className="py-10 flex justify-start gap-4 place-items-center">
