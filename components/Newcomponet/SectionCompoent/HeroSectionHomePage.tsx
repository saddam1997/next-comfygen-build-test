    ...
    >
          ...
          {/* {loadImages && (
            <>
              ...
              <div className="hidden sm:grid lg:grid-cols-3 sm:grid-cols-2 gap-4 py-6">
                <StatCard
                  img="https://www.comfygen.com/comfygen-images/comfygen/hero-experience-icon.webp"
                  text="6+ Year's Experience"
                />
                <StatCard
                  img="https://www.comfygen.com/comfygen-images/comfygen/heroproject-delivered-icon.webp"
                  text="250+ Project Delivered"
                />
                <StatCard
                  img="https://www.comfygen.com/comfygen-images/comfygen/happy-client-hero-icon.webp"
                  text="100+ Total Happy Client"
                />
              </div>
                ...
                <div className="grid grid-cols-3 gap-3">
                  {stats.map((s, i) => (
                    <div key={i} className="bg-white rounded-xl p-3 text-center">
                      <Image src={s.img} alt="" width={48} height={48} />
      ...
      {props.talkToExpertModal && (
        <div className="fixed inset-0 z-50 bg-black/80 flex items-center justify-center">
          <div className="bg-white rounded-xl w-11/12 lg:w-9/12 relative">
            <button
...
/* ================= SMALL COMPONENT ================= */
const StatCard = ({ img, text }: any) => (
  <div className="bg-white rounded-[14px] flex items-center gap-2 p-4">
    <Image src={img} alt="" width={32} height={32} />
    <p className="font-semibold text-black text-base">{text}</p>
  </div>
);
