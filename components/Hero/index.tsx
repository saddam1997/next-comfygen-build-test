...
//       {/* ================= BACKGROUND WAVES ================= */}
//       <div className={`absolute left-[-200px] top-[150px] opacity-40 ${styles.wave_drift}`}>
//         <Image src="/banner-bg.png" alt="" width={900} height={600} />
//       </div>
...
//             {/* Floating Circle Image */}
//             <div className={`relative w-80 h-80 md:w-[420px] md:h-[420px] rounded-full overflow-hidden z-10 ${styles.float_slow}shadow-2xl`}>
//               <Image
//                 src="/banner.jpg"
//                 alt="Hero"
//                 fill
...
//               <svg viewBox="0 0 200 200" className={`w-full h-full ${styles.rotate_slow}`}>
