...
export default function Tech({ TechStack }: any) {
  ...
  // ✅ Merge title/description from CMS with default categories
  const techData = {
    ...defaultTechData,
    ...TechStack,
  };
  ...
  // ✅ Remove non-category keys safely
  const techCategories = Object.keys(techData).filter(
    (key) => key !== "title" && key !== "description" && key !== "customTechData"
  );
