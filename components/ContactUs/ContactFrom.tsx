  ...
  render() {
    ...
    return (
      <div className="h-full">
        <form className="border rounded-xl lg:px-8 md:px-6 p-2 px-4 space-y-4 w-full">

          <div className="space-y-2">
            <h2 className="xl:text-4xl text-base font-semibold text-white">
              Get In Touch
            </h2>
              ...
              <div className="flex items-center border rounded ">
                ...
                >
                  ...
                  {JSON_DATA.Country?.map((ele) => (
                    <option className="text-gray-950" key={ele.code} value={ele.stdCode}>
