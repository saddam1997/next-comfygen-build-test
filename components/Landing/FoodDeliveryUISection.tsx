...
const uiImages = [
    {
        name: "Driver App",
        image:
            "https://www.comfygen.com/comfygen-images/food-delivery-app/driver.webp",
    },
    {
        name: "Admin Panel",
        image:
            "https://www.comfygen.com/comfygen-images/food-delivery-app/admin.webp",
    },
    {
        name: "User App",
        image:
            "https://www.comfygen.com/comfygen-images/food-delivery-app/User.webp",
    },
    {
        name: "Vendor Panel",
        image:
            "https://www.comfygen.com/comfygen-images/food-delivery-app/vendor.webp",
    },
];
...
export default function FoodDeliveryUISection({DATA}:any) {
    ...
    return (
        <section className="relative overflow-hidden bg-[#FAF6F2] py-16 sm:py-20 lg:py-10 mt-8">
            {/* BACKGROUND GLOW */}
            ...
            <div className="relative z-10 mx-auto max-w-[1300px] px-4 sm:px-6">
                ...
                {/* SLIDER */}
                <div className="relative flex min-h-[420px] items-center justify-center overflow-hidden sm:min-h-[560px] lg:min-h-[510px]">
                        ...
                        return (
                            ...
                            >
                                <div className="flex flex-col items-center">
                                    {/* MOBILE FRAME */}
                                    <div
                                        className={` relative overflow-hidden rounded-[32px] border border-white/40  shadow-[0_25px_70px_rgba(0,0,0,0.12)] backdrop-blur-xl transition-all duration-500 ${isActive ? "p-3 shadow-[0_35px_90px_rgba(255,90,60,0.22)]" : "p-2"}`}
                                    >
                                        {/* IMAGE AUTO HEIGHT */}
                                        <div className="relative w-[150px] sm:w-[220px] lg:w-[290px]">
                                            <Image
                                                src={item.image}
                                                alt={item.name}
                                                width={500}
                                    ...
                                    {/* NAME */}
                                    <div
                                        className={` mt-6 transition-all duration-500${isActive ? "translate-y-0 opacity-100" : "translate-y-4 opacity-0"
                                            }`}
                                    >
