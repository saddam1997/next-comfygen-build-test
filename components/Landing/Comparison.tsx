...
export default function Comparison() {
  const renderValue = (value: string) => {
    ...
    return (
      <span
        className={`${
          value === '60–70% lower' ? 'font-bold' : 'font-medium'
        }`}
      >
        {value}
      </span>
      ...
      <div className="mx-auto max-w-[1200px] px-4 sm:px-6">
        ...
        <div className="mx-auto mb-8 max-w-[720px] text-center sm:mb-10 lg:mb-14">
          ...
          <h2 className="mb-4 font-['Fraunces'] text-[28px] leading-[1.2] font-semibold tracking-[-0.02em] text-[#1A1614] sm:text-[32px] md:text-[36px] lg:text-[44px] lg:leading-[1.1]">
            Why food businesses choose us over{' '}
            <em className="italic text-[#FF5A3C]">
              freelancers & generic agencies
            </em>
          </h2>
          ...
          <p className="text-[14px] leading-[1.6] text-[#7A716C] sm:text-[15px] lg:text-[17px]">
            ...
            We're the safest bet for getting a working food delivery
            app launched on time.
          </p>
        </div>
          ...
          <table className="w-full border-collapse bg-[#FAF6F2]">
            ...
            <thead>
              <tr>
                ...
                <th className="border-b border-[#E8E2DD] bg-[#1A1614] bg-[rgba(255,90,60,0.05)] px-5 py-[18px] text-center text-[15px] font-semibold text-white">
                  Comfygen
                </th>
