    ...
    <div className="flex flex-col-reverse w-11/12 mx-auto 2xl:w-9/12 xl:w-5/6 lg:flex-row md:items-center lg:space-x-20 lg:space-y-0">
      <div className="w-full lg:pt-0 pt-10">
        <div className="space-y-6">
          ...
          <ul
            className="text-white/80 grid sm:grid-cols-2  gap-4 font-base p-4"
            
          >
            <li style={{ listStyleType: "disc", color: "white" }}> {props.li}</li>
            <li style={{ listStyleType: "disc", color: "white" }}> {props.li1}</li>
            <li style={{ listStyleType: "disc", color: "white" }}> {props.li2}</li>
            <li style={{ listStyleType: "disc", color: "white" }}>{props.li3}</li>
            <li style={{ listStyleType: "disc", color: "white" }}>{props.li4}</li>
            <li style={{ listStyleType: "disc", color: "white" }}>{props.li5}</li>
            <li style={{ listStyleType: "disc", color: "white" }}>{props.li6}</li>
            <li style={{ listStyleType: "disc", color: "white" }}>{props.li7}</li>
