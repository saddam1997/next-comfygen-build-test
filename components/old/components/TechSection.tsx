...
const techData = {
  backend: [
    ...
    {
      img: "https://www.comfygen.com/media/svg/tech/express-js-icon.svg",
      alt: "Express js",
      name: "Express js",
      num: "3",
    },
    ...
    {
      img: "https://www.comfygen.com/media/svg/tech/next-Js-icon.svg",
      alt: "Next js",
      name: "Next js",
      num: "5",
    },
  ...
  frontend: [
    ...
    {
      img: "https://www.comfygen.com/media/svg/tech/nextjs-original.svg",
      alt: "Nextjs",
      name: "nextjs",
      num: "3",
    },
  ...
  mobile: [
    ...
    {
      img: "https://www.comfygen.com/media/svg/tech/apple-original.svg",
      alt: "Apple",
      name: "IOS Apple",
      num: "2",
    },
    ...
    {
      img: "https://www.comfygen.com/media/svg/tech/unity-original.svg",
      alt: "Unity",
      name: "unity",
      num: "6",
    },
  ...
  crypto: [
    ...
    {
      img: "https://www.comfygen.com/img/stackimg/ethereum.svg",
      alt: "Ethereum",
      name: "Ethereum",
      num: "5",
    },
    ...
    {
      img: "https://www.comfygen.com/img/stackimg/solona.svg",
      alt: "Solona",
      name: "Solana",
      num: "9",
    },
...
export default function TechSection(props: any) {
  ...
  return (
    <>
      <section className="lg:py-16 py-10 bg-[#26304F] w-full ">
              ...
              <div className="py-4">
                <h2 className="font-bold 2xl:text-4xl xl:text-3xl text-2xl text-[#fff] text-start ">
                  {props.heading ? (
                    ...
                    <span>
                      {" "}
                      Our Edgy Tech-Stacks Use for Healthcare Software
                      Development
                    </span>
                  )}
                </h2>
                <p className="text-lg mt-2 text-white">
                  {props.content ? (
                    ...
                    <span>
                      The only focus is not the engagement, but building a
                      highly-secured and robust web or application. For strong
                      Healthcare Software development, some edgy tech stacks are
                      being used.
                    </span>
                  )}
                </p>
